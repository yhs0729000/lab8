...
Ally::Ally(QGraphicsItem *parent){
    // set graphics
    setPixmap(QPixmap(":/new/images/ally.png"));
...
void Ally::rotateToPoint(QPointF p){
    QLineF ln(pos(),p);
    setRotation(-1 * ln.angle());
}

void Ally::move_forward(){
...
bool Ally::adddamage(int damage){
