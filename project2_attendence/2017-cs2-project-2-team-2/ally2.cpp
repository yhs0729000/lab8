...
#include "game.h"
extern Game *game;
Ally2::Ally2(QGraphicsItem *parent){
    // set graphics
    setPixmap(QPixmap(":/new/images/ally2.png"));
...
void Ally2::rotateToPoint(QPointF p){
    QLineF ln(pos(),p);
    setRotation(-1 * ln.angle());
}

void Ally2::move_forward(){
...
bool Ally2::adddamage(int damage){
