...
#include "game.h"
extern Game *game;
Ally3::Ally3(QGraphicsItem *parent){
    // set graphics
    setPixmap(QPixmap(":/new/images/ally3.png"));
...
void Ally3::rotateToPoint(QPointF p){
    QLineF ln(pos(),p);
    setRotation(-1 * ln.angle());
}

void Ally3::move_forward(){
...
bool Ally3::adddamage(int damage){
